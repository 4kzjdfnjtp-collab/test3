...
public sealed class FLPSaveOptions
{
	...
	/// <summary>If true, every "MIDI Out" channel is written with MIDI Port 0 instead of using the original track's MIDI channel as the port number.</summary>
	public bool ForceMIDIOutPortZero;
